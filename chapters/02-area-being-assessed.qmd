...
A](12-Appendices.qmd#sec-appendix-a-map). The Region is a topically diverse
...
rural. See map in [Appendix B](12-Appendices.qmd#sec-appendix-b-map).
...
schools. See map in [Appendix C](12-Appendices.qmd#sec-appendix-c-map).
...
D](12-Appendices.qmd#sec-appendix-d-map).
...
one third of the county by area. See map in [Appendix E](12-Appendices.qmd#sec-appendix-e-map).
...
villages. See map in [Appendix F](12-Appendices.qmd#sec-appendix-f-map).
...
G](12-Appendices.qmd#sec-appendix-g-map).
...
colleges and universities. See map in [Appendix H](12-Appendices.qmd#sec-appendix-h-map).
