...
Premature death for those less than 65 years is the 2nd worst in the M-H Region and worse than the NYS rate [@fig-premature-death-percent]. Heart disease and cancer are the leading causes of death and premature death (death before
...
- Ulster County is among the counties in the region with the highest percentages reporting food insecurity [@fig-lead-children], as well as population at poverty level or below [@fig-poverty-rate]. In addition, a high percentage of people report living with a disability [@tbl-disability].Can 
